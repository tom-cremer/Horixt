...
<body
    class="bg-[#FDFDFC]  dark:bg-zinc-800 text-[#1b1b18] ">
<section
    class="mt-4 sm:mt-6 wrapper wrapper--smaller relative flex flex-col items-center px-6 bg-[#FDFDFC] dark:bg-zinc-800 overflow-hidden">
    <header
        class="flex items-center justify-between w-full text-sm  mx-auto not-has-[nav]:hidden">
        <a
            href="/"
    ...
    <!-- Dashboard Preview -->
    <div
        class="mt-10 relative w-full max-w-5xl overflow-hidden max-h-1/2 z-0 pointer-events-none ">
        <!-- Desktop Screen -->
        <div
            class="hidden md:block rounded-xl mx-auto max-w-[900px] overflow-hidden border border-gray-300 dark:border-zinc-800 shadow-lg">
            <img src="{{asset('images/desktop_horixt2.png')}}" alt="{{config('app.name')}} Dashboard Preview - Desktop"
                 class="w-full">
        </div>
        <!-- Tablet Screen -->
        <div class="hidden sm:block md:hidden rounded-xl overflow-hidden border border-gray-300 dark:border-zinc-800 shadow-lg">
            <img src="{{asset('images/tablet_horixt2.png')}}" alt="{{config('app.name')}} Dashboard Preview - Tablet"
                 class="w-full object-cover">
        </div>
        <!-- Smartphone Screen -->
        <div class="block sm:hidden rounded-xl overflow-hidden border border-gray-300 dark:border-zinc-800 mx-auto max-w-[400px] shadow-lg">
            <img src="{{asset('images/phone_horixt.png')}}" alt="{{config('app.name')}} Dashboard Preview - Smartphone"
                 class="w-full object-cover">
        </div>
    </div>
</section>
...
<section
    class="relative  text-white text-center">
    <div class=" wrapper wrapper--none">
        <div class=" py-6 bg-gradient-to-r from-[#7F76FF] to-[#675CFF]  -translate-y-4 shadow-lg">
...
<section id="features" class="py-10 sm:py-16">
    <div class="max-w-7xl mx-auto px-6 lg:px-12 wrapper wrapper--smaller">
...
<section class="mt-4 sm:mt-10 relative  overflow-hidden">

    <div class="wrapper wrapper--smaller">

        <div
            class="bg-[#FDFDFC] dark:bg-zinc-700 py-10 sm:py-16 rounded-4xl max-w-6xl mx-auto px-0 sm:px-10 flex flex-col lg:flex-row items-center gap-12">
            ...
            <div class="flex-1">
                <div class="rounded-lg overflow-hidden border border-zinc-200 dark:border-zinc-800 shadow-md sm:shadow-2xl">
                    <img src="{{asset('images/desktop_horixt.png')}}" alt="Dashboard Demo" class="w-full">
                </div>
            </div>
        </div>
    </div>
...
<section class="my-32 ">
    <div class="wrapper wrapper--smaller">
        <div class="flex flex-col items-center px-6 text-center">
            <h2 class="text-4xl md:text-5xl font-extrabold mb-6 dark:text-white text-zinc-800">Time to work smarter, not
                harder</h2>
            <p class="text-lg md:text-xl mb-8 dark:text-white text-zinc-800">
                Whether you're solo or scaling your team — {{config('app.name')}} is built to adapt, grow, and simplify
                your
                process.
            </p>
