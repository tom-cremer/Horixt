...
<section class="relative h-screen max-h-[1024px] flex flex-col items-center px-6 bg-[#FDFDFC] dark:bg-zinc-800 overflow-hidden">
    ...
    <div class="absolute bottom-1/2 right-6 lg:block hidden animate-float-fast animate-[float_5s_ease-in-out_infinite] z-10">
        <div
            class="bg-white dark:bg-zinc-700 border border-zinc-200 dark:border-zinc-600 p-4 rounded-xl shadow-md text-xs text-gray-500 w-40">
            <flux:text variant="strong">📁 Files Manager</flux:text>
        </div>
    </div>
    <div class="absolute top-3/4 left-2 lg:block hidden animate-float-fast animate-[float_6s_ease-in-out_infinite] z-10">
        <div
            class="bg-white dark:bg-zinc-700 border border-zinc-200 dark:border-zinc-600 p-4 rounded-xl shadow-md text-xs text-gray-500 w-40">
    ...
    <div class="max-w-lg text-center relative z-10 flex flex-col items-center mt-24">
        ...
        <h1 class="text-4xl md:text-5xl font-bold leading-tight text-zinc-800 dark:text-white ">
            Organize your work with <b class="text-[#7F76FF] dark:text-[#7F76FF] font-extrabold">{{config('app.name')}}</b>
        </h1>
 ...
 <div
     ...
     <div class="hidden sm:block md:hidden rounded-3xl overflow-hidden border border-gray-200 dark:border-zinc-800">
         <img src="https://placehold.co/700x900" alt="{{config('app.name')}} Dashboard Preview - Tablet" class="w-full object-cover">
     </div>
     <!-- Smartphone Screen -->
     <div class="block sm:hidden rounded-3xl overflow-hidden border border-gray-200 dark:border-zinc-800">
         <img src="https://placehold.co/400x600" alt="{{config('app.name')}} Dashboard Preview - Smartphone" class="w-full object-cover">
     </div>
 </div>
</section>
    ...
    <div class="max-w-7xl mx-auto px-6 lg:px-12">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
            <div class="bg-[#f7f7f5] dark:bg-zinc-700 p-6 rounded-2xl shadow-sm hover:shadow-md transition">
                ...
                <p class="text-sm text-zinc-600 dark:text-zinc-400">Structure work the way your brain works — with nesting, statuses, and priorities.</p>
            </div>
            <div class="bg-[#EAE8FF] p-6 rounded-2xl shadow-sm hover:shadow-md transition">
                ...
                <p class="text-sm text-zinc-700">Track real hours on real work. Integrated into every to-do for accuracy you can trust.</p>
            </div>
            <div class="bg-[#f7f7f5] dark:bg-zinc-700 p-6 rounded-2xl shadow-sm hover:shadow-md transition">
                <h3 class="text-xl font-semibold text-zinc-900 dark:text-white mb-2">📁 Smart File Management</h3>
                <p class="text-sm text-zinc-600 dark:text-zinc-400">Store, preview, and lock files — with version control and granular access.</p>
            </div>
            <div class="bg-[#D7F8E4] p-6 rounded-2xl shadow-sm hover:shadow-md transition">
                ...
                <p class="text-sm text-zinc-800">Choose what you need, nothing more. Notes, clients, calendar — à la carte.</p>
            </div>
            <div class="bg-[#f7f7f5] dark:bg-zinc-700 p-6 rounded-2xl shadow-sm hover:shadow-md transition">
                <h3 class="text-xl font-semibold text-zinc-900 dark:text-white mb-2">🧑‍💼 Organizations</h3>
                <p class="text-sm text-zinc-600 dark:text-zinc-400">Built for teams. Manage roles, invite clients, and keep control over your structure.</p>
            </div>
            <div class="bg-[#FFE9E2] p-6 rounded-2xl shadow-sm hover:shadow-md transition">
                ...
                <p class="text-sm text-zinc-800">Know where your time goes. Analyze by task, team, or project in a click.</p>
            </div>
        </div>
    </div>
</section>
    ...
    <div class="max-w-6xl mx-auto px-10 flex flex-col lg:flex-row items-center gap-12">
        <div class="flex-1 space-y-6">
            ...
            <p class="text-lg text-zinc-600 dark:text-zinc-400">
                Create, assign, track, and deliver — without switching tabs. {{config('app.name')}} adapts to your rhythm.
            </p>
            <ul class="space-y-3">
                <li class="flex items-center gap-3">
                    <span class="text-[#7F76FF]">✓</span> <flux:text>Nestable tasks with timelines</flux:text>
                </li>
                <li class="flex items-center gap-3">
                    <span class="text-[#7F76FF]">✓</span> <flux:text>Time tracking integrated at every level</flux:text>
                </li>
                <li class="flex items-center gap-3">
                    <span class="text-[#7F76FF]">✓</span> <flux:text>Insights that go beyond timesheets</flux:text>
                </li>
            </ul>
        </div>
...
<section class="py-24  text-white text-center">
    <div class="max-w-3xl mx-auto px-6">
        <h2 class="text-4xl md:text-5xl font-extrabold mb-6">Time to work smarter, not harder</h2>
        <p class="text-lg md:text-xl mb-8">
            Whether you're solo or scaling your team — {{config('app.name')}} is built to adapt, grow, and simplify your process.
        </p>
...
<!-- Footer -->
<footer class="flex flex-col items-center w-full min-h-24">
